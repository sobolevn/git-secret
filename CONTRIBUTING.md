...
It was once the case that creating a commit inside `master` branch, `travis` on successful build should publish new `deb` and `rpm` packages to [`bintray`][bintray]. 
